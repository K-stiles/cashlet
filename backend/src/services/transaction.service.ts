...
export const createTransactionService = async (
  ...
  /**
   * If is recurring = true and recurring interval = 'DAILY'|'MONTHLY' or etc.. calculate next recurring date
   * based on the transaction date and recurring interval
   */
  if (body.isRecurring && body.recurringInterval) {
    ...
    /**
     * If the calculated next recurring date is in the past, calculate the next occurrence
     * from the current date to ensure it's always in the future otherwise use the calculated date
     */
    nextRecurringDate =
...
export const scanReceiptService = async (
  ...
  try {
    ...
    console.log("cloudinary upload file path", file.path);
