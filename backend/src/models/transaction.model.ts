...
const transactionSchema = new Schema<TransactionDocument>(
  ...
  },
  {
    timestamps: true,
    /**
     * Including the getters in toJSON and toObject to ensure that the amount is converted back to dollars when the document is serialized or converted to a plain object.
     */
